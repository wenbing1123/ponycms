/**
 * @class App.ux.portal.PortalDropZone
 * @extends Ext.dd.DropTarget
 * Internal class that manages drag/drop for {@link App.ux.portal.PortalPanel}.
 */
Ext.define('App.ux.portal.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        App.ux.portal.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        App.ux.portal.PortalDropZone.superclass.unreg.call(this);
    }
});
