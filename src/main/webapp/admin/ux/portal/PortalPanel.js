...
Ext.define('App.ux.portal.PortalPanel', {
    ...
    requires: [
        ...
        'App.ux.portal.PortalDropZone',
        'App.ux.portal.PortalColumn'
    ],
    ...
    initEvents : function(){
        this.callParent();
        this.dd = Ext.create('App.ux.portal.PortalDropZone', this, this.dropConfig);
    },
