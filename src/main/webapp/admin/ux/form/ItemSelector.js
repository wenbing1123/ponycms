...
/**
 * A control that allows selection of between two App.ux.form.MultiSelect controls.
 */
Ext.define('App.ux.form.ItemSelector', {
    extend: 'App.ux.form.MultiSelect',
    alias: ['widget.itemselectorfield', 'widget.itemselector'],
    alternateClassName: ['App.ux.ItemSelector'],
    requires: [
        'Ext.button.Button',
        'App.ux.form.MultiSelect'
    ],
    ...
    createList: function(title){
        ...
        return Ext.create('App.ux.form.MultiSelect', {
